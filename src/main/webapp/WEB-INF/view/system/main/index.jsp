...
<head>
    ...
    <link rel="icon" href="${morron}/static/favicon.ico">
    <link rel="stylesheet" href="${morron}/static/layui/css/layui.css" media="all"/>
    <link rel="stylesheet" href="${morron}/static/css/index.css" media="all"/>
    <style>
        @font-face {
            font-family: "seraph";
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${morron}/static/images/face.jpg" class="layui-nav-img userAvatar"
                                                width="35" height="35"><cite
                            class="adminName">${user.realname}</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="${morron}/static/page/user/userInfo.html"><i
                                class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="javascript:;" data-url="${morron}/static/page/user/changePwd.html"><i
                        ...
                        <dd><a href="${morron}" class="signOut"><i
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${morron}/static/images/face.jpg" class="userAvatar"></a>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${morron}/static/page/main.html">
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="${morron}/desk/toDeskManager.action"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="${morron}/static/layui/layui.js"></script>
<script type="text/javascript" src="${morron}/static/js/cache.js"></script>
<script type="text/javascript">
    var $, tab, dataStr, layer;
    layui.config({
        base: "${morron}/static/js/"
    }).extend({
        "bodyTab": "bodyTab"
    })
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            url: "${morron}/menu/loadIndexleftMenuJson.action" //获取菜单json地址
        });
