...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${morron}/check/checkRentExist.action", {rentid: rentid}, function (obj) {
        ...
        function initCheckFormData(rentid) {
            $.post("${morron}/check/initCheckFormData.action",{rentid:rentid},function (obj) {
                //检查单
                var check=obj.check;
                ...
                $("#car_carimg").attr("src","${morron}/file/downloadShowFile.action?path="+car.carimg);
            })
        }
        //保存
        form.on("submit(doSubmit)",function () {
            var params = $("#checkFrm").serialize();
            $.post("${morron}/check/saveCheck.action",params,function (obj) {
                layer.msg(obj.msg);
                $("#content").hide();
            })
            return false;
